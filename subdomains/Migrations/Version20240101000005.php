...
final class Version20240101000005 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO setting (name, value, type, context, hierarchy, nullable) VALUES ('default_ttl', '1', 'string', 'plugin:subdomains', 100, false)");

        // Advanced settings (hierarchy: 200)
        $this->addSql("INSERT INTO setting (name, value, type, context, hierarchy, nullable) VALUES ('auto_delete_on_terminate', '1', 'boolean', 'plugin:subdomains', 200, false)");
        $this->addSql("INSERT INTO setting (name, value, type, context, hierarchy, nullable) VALUES ('auto_suspend_on_suspend', '1', 'boolean', 'plugin:subdomains', 200, false)");
        $this->addSql("INSERT INTO setting (name, value, type, context, hierarchy, nullable) VALUES ('rate_limit', '5', 'integer', 'plugin:subdomains', 200, false)");
    }
